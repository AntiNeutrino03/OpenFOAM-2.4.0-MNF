...
void forwardAssociativeIonisation::setProperties()
{
    ...
    List<label> assIonProds = associativeIonisationProductIds_;

    scalar rDofProd1 =
            cloud_.constProps(assIonProds[0]).rotationalDegreesOfFreedom();
    ...
    const List<word> ionisationProductMolecules
    ...
    rDofProd1 =
     cloud_.constProps(ionisationProductIds_[0]).rotationalDegreesOfFreedom();
    ...
    word intermediateMolecule (propsDict_.lookup("intermediateMolecule"));
...
bool forwardAssociativeIonisation::tryReactMolecules(const label typeIdP,
                                                     const label typeIdQ)
{
...
bool forwardAssociativeIonisation::relax() const
{
    return relax_;
}
