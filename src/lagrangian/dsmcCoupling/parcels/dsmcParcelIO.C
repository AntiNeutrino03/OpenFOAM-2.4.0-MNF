...
void Foam::solidParticle::readFields(Cloud<solidParticle>& c)
{
    ...
    IOField<vector> Up(c.fieldIOobject("Up", IOobject::MUST_READ));
    c.checkFieldIOobject(c, Up);
...
void Foam::solidParticle::writeFields(const Cloud<solidParticle>& c)
{
    ...
    IOField<vector> Up(c.fieldIOobject("Up", IOobject::NO_READ), np);
