...
// void Foam::dsmcCloud::calculateSolidParticleRelatedParameters()
// {   
...
:
    ...
    d_(dimensionedScalar(particleProperties_.lookup("d_")).value()),
    epsilon_(dimensionedScalar(particleProperties_.lookup("epsilon_")).value()),
    alpha_(dimensionedScalar(particleProperties_.lookup("alpha_")).value()),
    Tp_()
...
void Foam::dsmcCloud::evolve()
{
    ...
    Cloud<dsmcParcel>::move(td, mesh_.time().deltaTValue()); //pass density, velocity, etc.
